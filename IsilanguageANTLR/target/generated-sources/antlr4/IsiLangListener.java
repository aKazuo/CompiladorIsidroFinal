...
public interface IsiLangListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmdraiz(@NotNull IsiLangParser.CmdraizContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdraiz}.
	 * @param ctx the parse tree
	 */
	void exitCmdraiz(@NotNull IsiLangParser.CmdraizContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmdtesta(@NotNull IsiLangParser.CmdtestaContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdtesta}.
	 * @param ctx the parse tree
	 */
	void exitCmdtesta(@NotNull IsiLangParser.CmdtestaContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmdcaso(@NotNull IsiLangParser.CmdcasoContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdcaso}.
	 * @param ctx the parse tree
	 */
	void exitCmdcaso(@NotNull IsiLangParser.CmdcasoContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmdenq(@NotNull IsiLangParser.CmdenqContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmdlog(@NotNull IsiLangParser.CmdlogContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdlog}.
	 * @param ctx the parse tree
	 */
	void exitCmdlog(@NotNull IsiLangParser.CmdlogContext ctx);
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#fator}.
	 * @param ctx the parse tree
	 */
	void enterFator(@NotNull IsiLangParser.FatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#fator}.
	 * @param ctx the parse tree
	 */
	void exitFator(@NotNull IsiLangParser.FatorContext ctx);
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#cmdmat}.
	 * @param ctx the parse tree
	 */
	void enterCmdmat(@NotNull IsiLangParser.CmdmatContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdmat}.
	 * @param ctx the parse tree
	 */
	void exitCmdmat(@NotNull IsiLangParser.CmdmatContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterCmdexp(@NotNull IsiLangParser.CmdexpContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#cmdexp}.
	 * @param ctx the parse tree
	 */
	void exitCmdexp(@NotNull IsiLangParser.CmdexpContext ctx);
	/**
